...
using Sedulous.Shims.iOS;
using Sedulous.Shims.iOS.Graphics;
using Sedulous.Shims.iOS.Input;
using Sedulous.Shims.iOS.Platform;
        ...
        IDisposable
    {
        ...
        private void InitializeFrameworkContext()
        {
            context.ConfigureFactory((factory) =>
            {
                ...
                factory.SetFactoryMethod<ScreenRotationServiceFactory>((display) => new iOSScreenOrientationService(display));

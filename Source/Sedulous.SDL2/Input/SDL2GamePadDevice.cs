...
namespace Sedulous.SDL2.Input
{
        ...
        IMessageSubscriber<SedulousMessageID>
    {
                ...
                case SDL_CONTROLLERBUTTONDOWN:
                    {
                        if (evt.cbutton.which == instanceID)
                        {
                            ...
                            var button = SDLToSedulousButton((SDL_GameControllerButton)evt.cbutton.button);
        ...
        /// <summary>
        /// Converts an SDL2 SDL_GameControllerButton value to an Sedulous GamePadButton value.
        /// </summary>
        ...
        private static GamePadButton SDLToSedulousButton(SDL_GameControllerButton button) => (GamePadButton)(1 + (int)button);

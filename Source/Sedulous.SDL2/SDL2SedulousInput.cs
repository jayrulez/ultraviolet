...
namespace Sedulous.SDL2
{
    ...
    /// </summary>
    public sealed class SDL2SedulousInput : SedulousResource, ISedulousInput, IMessageSubscriber<SedulousMessageID>
    {
        /// <summary>
        /// Initializes a new instance of the SDL2SedulousInput class.
        /// </summary>
        /// <param name="uv">The Sedulous context.</param>
        public SDL2SedulousInput(SedulousContext uv)
            : base(uv)
        {
        ...
        /// </summary>
        private void LoadGameControllerMappingDatabase(SedulousContext uv)
        {

...
{
    /// <summary>
    /// Represents the SDL2 implementation of the <see cref="ISedulousWindowInfo"/> interface.
    /// </summary>
    public abstract class SDL2SedulousWindowInfo : ISedulousWindowInfo, ISedulousComponent
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SDL2SedulousWindowInfo"/> class.
        /// </summary>
        /// <param name="uv">The Sedulous context.</param>
        /// <param name="configuration">The Sedulous configuration settings for the current context.</param>
        internal SDL2SedulousWindowInfo(SedulousContext uv, SedulousConfiguration configuration)
        {
        ...
        public void Update(SedulousTime time)
        {
            foreach (var window in windows)
                ((SDL2SedulousWindow)window).Update(time);
        }
        ...
        {
            var match = default(SDL2SedulousWindow);
            foreach (SDL2SedulousWindow window in windows)
            {
        ...
        public IntPtr GetPtrByID(Int32 id)
        {
            ...
            if (window != null)
            {
                return (IntPtr)(SDL2SedulousWindow)window;
            }
            return IntPtr.Zero;
        }
        ...
        public ISedulousWindow GetMaster()
        {
            return Master;
        }
        ...
        {
            return (IntPtr)(SDL2SedulousWindow)Master;
        }
        ...
        {
            return (IntPtr)(SDL2SedulousWindow)Primary;
        }
        ...
        {
            return (IntPtr)(SDL2SedulousWindow)Current;
        }
        ...
        public ISedulousWindow Create(String caption, Int32 x, Int32 y, Int32 width, Int32 height, WindowFlags flags = WindowFlags.None)
        {
            ...
            var win = new SDL2SedulousWindow(Sedulous, sdlptr, visible);
            windows.Add(win);

            Sedulous.Messages.Subscribe(win, SDL2SedulousMessages.SDLEvent);
        ...
        public ISedulousWindow CreateFromNativePointer(IntPtr ptr)
        {
            ...
            var win = new SDL2SedulousWindow(Sedulous, sdlptr, true);
            windows.Add(win);
        ...
        public Boolean Destroy(ISedulousWindow window)
        {
            ...
            var sdlwin = (SDL2SedulousWindow)window;
            Sedulous.Messages.Unsubscribe(sdlwin, SDL2SedulousMessages.SDLEvent);
        ...
        /// </summary>
        internal void InitializePrimaryWindow(SedulousContext uv, SedulousConfiguration configuration)
        {
            if (Master != null)
                throw new InvalidOperationException(SedulousStrings.PrimaryWindowAlreadyInitialized);
            ...
            var isRunningOnMobile = (Sedulous.Platform == SedulousPlatform.Android || Sedulous.Platform == SedulousPlatform.iOS);
            ...
            var caption = String.IsNullOrEmpty(uv.Host.ApplicationName) ? (String)SedulousStrings.DefaultWindowCaption : uv.Host.ApplicationName;
            ...
            this.Master = new SDL2SedulousWindow(Sedulous, masterptr, isRunningOnMobile);
        ...
        protected virtual Boolean InitializeRenderingAPI(SedulousGraphicsConfiguration graphicsConfiguration, Int32 attempt)
        {
            return false;
        }
        ...
        protected virtual void OnWindowCleanup(ISedulousWindow window)
        { }
        ...
        protected virtual void OnWindowCreated(ISedulousWindow window) =>
        ...
        protected virtual void OnWindowDestroyed(ISedulousWindow window) =>
        ...
        /// </summary>
        protected IList<ISedulousWindow> Windows { get { return windows; } }

        /// <summary>
        /// Gets or sets the master window.
        /// </summary>
        protected ISedulousWindow Master { get; set; }

        /// <summary>
        /// Gets or sets the primary window.
        /// </summary>
        protected ISedulousWindow Primary { get; set; }

        /// <summary>
        /// Gets or sets the current window.
        /// </summary>
        protected ISedulousWindow Current { get; set; }

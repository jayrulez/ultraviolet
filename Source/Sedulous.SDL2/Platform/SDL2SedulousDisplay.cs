...
{
    /// <summary>
    /// Represents the SDL2 implementation of the <see cref="ISedulousDisplay"/> interface.
    /// </summary>
    public sealed unsafe class SDL2SedulousDisplay : ISedulousDisplay
    {
        /// <summary>
        ...
        public SDL2SedulousDisplay(SedulousContext uv, Int32 displayIndex)
        {
        ...
        internal void RefreshDensityInformation()
        {
            ...
            if (screenDensityService.Refresh())
            {
                ...
                uv.Messages.Publish(SedulousMessages.DisplayDensityChanged, messageData);

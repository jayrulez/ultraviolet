...
namespace Sedulous.Core.Data
{
    ...
    public static class ObjectResolver
    {
        ...
        /// <summary>
        /// Gets a value indicating whether the specified type is a lazily-loaded Sedulous data object.
        /// </summary>
        /// <param name="type">The type to evaluate.</param>
        /// <param name="dataObjectType">The type of data object to load.</param>
        /// <returns><see langword="true"/> if the specified type is a lazily-loaded Sedulous data object; otherwise, <see langword="false"/>.</returns>

...
namespace Sedulous.Core.IO
{
    ...
    public static class BinaryWriterExtensions
    {
        ...
        /// <summary>
        /// Writes a resolved reference to an Sedulous data object to the stream.
        /// </summary>
        ...
        /// <summary>
        /// Writes a <see langword="null"/>able resolved reference to an Sedulous data object to the stream.
        /// </summary>
        /// <param name="writer">The <see cref="BinaryWriter"/> with which to write the data object reference.</param>

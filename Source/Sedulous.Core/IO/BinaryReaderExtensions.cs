...
namespace Sedulous.Core.IO
{
    ...
    public static class BinaryReaderExtensions
    {
        ...
        /// <summary>
        /// Reads a resolved reference to a Sedulous data object from the stream.
        /// </summary>
        ...
        /// <summary>
        /// Reads a <see langword="null"/>able resolved reference to an Sedulous data object from the stream.
        /// </summary>
        /// <param name="reader">The <see cref="BinaryReader"/> from which to read the data object reference.</param>

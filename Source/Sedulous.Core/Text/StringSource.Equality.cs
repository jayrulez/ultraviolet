...
namespace Sedulous.Core.Text
{
    partial struct StringSource : IEquatable<String>, IEquatable<StringSource>, IEquatable<StringBuilderSource>, IEquatable<StringSegmentSource>
    {
        /// <summary>
        /// Compares a <see cref="StringSource"/> instance with a <see cref="String"/> instance
        /// to determine whether they are equal; that is, whether the contain the same characters.
        /// </summary>
        /// <param name="ss">The <see cref="StringSource"/> instance to compare.</param>
        /// <param name="other">The <see cref="String"/> instance to compare.</param>
        /// <returns><see langword="true"/> if the instances are equal; otherwise, <see langword="false"/>.</returns>
        public static Boolean operator ==(StringSource ss, String other) =>
            ss.Equals(other);
        ...
        /// <summary>
        /// Compares a <see cref="String"/> instance with a <see cref="StringSource"/> instance
        /// to determine whether they are equal; that is, whether the contain the same characters.
        /// </summary>
        /// <param name="str">The <see cref="String"/> instance to compare.</param>
        /// <param name="ss">The <see cref="StringSource"/> instance to compare.</param>
        /// <returns><see langword="true"/> if the instances are equal; otherwise, <see langword="false"/>.</returns>
        public static Boolean operator ==(String str, StringSource ss) =>
            ss.Equals(str);
        ...
        /// <summary>
        /// Compares a <see cref="StringSource"/> instance with a <see cref="StringSource"/> instance
        /// to determine whether they are equal; that is, whether the contain the same characters.
        /// </summary>
        /// <param name="ss">The <see cref="StringSource"/> instance to compare.</param>
        /// <param name="other">The <see cref="StringSource"/> instance to compare.</param>
        /// <returns><see langword="true"/> if the instances are equal; otherwise, <see langword="false"/>.</returns>
        public static Boolean operator ==(StringSource ss, StringSource other) =>
            ss.Equals(other);
        ...
        /// <summary>
        /// Compares a <see cref="StringSource"/> instance with a <see cref="StringBuilderSource"/> instance
        /// to determine whether they are equal; that is, whether the contain the same characters.
        /// </summary>
        /// <param name="ss">The <see cref="StringSource"/> instance to compare.</param>
        /// <param name="other">The <see cref="StringBuilderSource"/> instance to compare.</param>
        /// <returns><see langword="true"/> if the instances are equal; otherwise, <see langword="false"/>.</returns>
        public static Boolean operator ==(StringSource ss, StringBuilderSource other) =>
            ss.Equals(other);
        ...
        /// <summary>
        /// Compares a <see cref="StringSource"/> instance with a <see cref="StringSegmentSource"/> instance
        /// to determine whether they are equal; that is, whether the contain the same characters.
        /// </summary>
        /// <param name="ss">The <see cref="StringSource"/> instance to compare.</param>
        /// <param name="other">The <see cref="StringSegmentSource"/> instance to compare.</param>
        /// <returns><see langword="true"/> if the instances are equal; otherwise, <see langword="false"/>.</returns>
        public static Boolean operator ==(StringSource ss, StringSegmentSource other) =>
            ss.Equals(other);

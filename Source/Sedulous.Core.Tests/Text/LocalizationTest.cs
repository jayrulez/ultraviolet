...
namespace Sedulous.Core.Tests.Text
{
    ...
    public partial class LocalizationTest : CoreTestFramework
    {
        ...
        private void LoadTestLocalizationDatabaseFromXml()
        {
            ...
            using (var manifestResourceStream = GetType().Assembly.GetManifestResourceStream("Sedulous.Core.Tests.Resources.LocalizedStrings.xml"))
        ...
        private void LoadTestLocalizationDatabaseFromJson()
        {
            ...
            using (var manifestResourceStream = GetType().Assembly.GetManifestResourceStream("Sedulous.Core.Tests.Resources.LocalizedStrings.json"))

...
namespace Sedulous.Core.Tests.Data
{
    ...
    public class ObjectLoaderTest : CoreTestFramework
    {
        ...
        public void ObjectLoader_MustSpecifyKey()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
                        <StringValue>foo</StringValue>
                    </SimpleModel>
                </SimpleModels>");
        ...
        public void ObjectLoader_MustSpecifyID()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1'>
                        <StringValue>foo</StringValue>
                    </SimpleModel>
                </SimpleModels>");
        ...
        public void ObjectLoader_ClassMustExist()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel Class='Sedulous.Core.Tests.Data.ClassWhichDoesNotExist, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
                        <StringValue>foo</StringValue>
                    </SimpleModel>
                </SimpleModels>");
        ...
        public void ObjectLoader_ClassAlias_MustSpecifyName()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <Aliases>
                        <Alias>Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, Sedulous.Core.Tests</Alias>
                    </Aliases>
                    <SimpleModel Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1'>
                        <StringValue>foo</StringValue>
                    </SimpleModel>
        ...
        public void ObjectLoader_ClassAlias_LoadsSuccessfullyWhenSpecified()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <Aliases>
                        <Alias Name='Foo'>Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"</Alias>
                    </Aliases>
        ...
        public void ObjectLoader_ClassAlias_LoadsSuccessfullyWhenDefault()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <Aliases>
                        <Alias Name='Foo' Default='true'>Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"</Alias>
                    </Aliases>
                    <SimpleModel Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
                        <StringValue>Hello, world!</StringValue>
                    </SimpleModel>
        ...
        public void ObjectLoader_SimpleObject_ThrowsOnMissingFields()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
        ...
        public void ObjectLoader_SimpleObject_ThrowsOnMissingFields_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel FooValue='Hello, world!' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_LoadsStringSuccessfully()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    ...
                    <SimpleModel Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT2' ID='2dcf947d-6bc4-4f98-85ae-ca8e56db3109'>
                        <StringValue>Goodbye, world!</StringValue>
                    </SimpleModel>
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_LoadsStringSuccessfully_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel StringValue='Hello, world!' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                    <SimpleModel StringValue='Goodbye, world!' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT2' ID='2dcf947d-6bc4-4f98-85ae-ca8e56db3109' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_LoadsBooleanSuccessfully_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel BooleanValue='True' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                    <SimpleModel BooleanValue='False' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT2' ID='2dcf947d-6bc4-4f98-85ae-ca8e56db3109' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_ThrowsOnInvalidBoolean_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel BooleanValue='foo' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_LoadsSByteSuccessfully_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel SByteValue='-64' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                    <SimpleModel SByteValue='64' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT2' ID='2dcf947d-6bc4-4f98-85ae-ca8e56db3109' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_ThrowsOnInvalidSByte_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel SByteValue='foo' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_LoadsByteSuccessfully_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel ByteValue='64' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                    <SimpleModel ByteValue='128' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT2' ID='2dcf947d-6bc4-4f98-85ae-ca8e56db3109' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_ThrowsOnInvalidByte_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel ByteValue='foo' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_LoadsCharSuccessfully_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel CharValue='A' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                    <SimpleModel CharValue='F' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT2' ID='2dcf947d-6bc4-4f98-85ae-ca8e56db3109' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_ThrowsOnInvalidChar_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel CharValue='foo' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_LoadsInt16Successfully_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel Int16Value='-123' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                    <SimpleModel Int16Value='456' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT2' ID='2dcf947d-6bc4-4f98-85ae-ca8e56db3109' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_ThrowsOnInvalidInt16_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel Int16Value='foo' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_LoadsInt32Successfully_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel Int32Value='-123' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                    <SimpleModel Int32Value='456' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT2' ID='2dcf947d-6bc4-4f98-85ae-ca8e56db3109' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_ThrowsOnInvalidInt32_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel Int32Value='foo' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_LoadsInt64Successfully_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel Int64Value='-123' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                    <SimpleModel Int64Value='456' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT2' ID='2dcf947d-6bc4-4f98-85ae-ca8e56db3109' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_ThrowsOnInvalidInt64_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel Int64Value='foo' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_LoadsUInt16Successfully_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel UInt16Value='123' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                    <SimpleModel UInt16Value='456' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT2' ID='2dcf947d-6bc4-4f98-85ae-ca8e56db3109' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_ThrowsOnInvalidUInt16_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel UInt16Value='foo' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_LoadsUInt32Successfully_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel UInt32Value='123' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                    <SimpleModel UInt32Value='456' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT2' ID='2dcf947d-6bc4-4f98-85ae-ca8e56db3109' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_ThrowsOnInvalidUInt32_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel UInt32Value='foo' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_LoadsUInt64Successfully_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel UInt64Value='123' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                    <SimpleModel UInt64Value='456' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT2' ID='2dcf947d-6bc4-4f98-85ae-ca8e56db3109' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_ThrowsOnInvalidUInt64_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel UInt64Value='foo' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_LoadsSingleSuccessfully_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel SingleValue='-123.456' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                    <SimpleModel SingleValue='456.789' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT2' ID='2dcf947d-6bc4-4f98-85ae-ca8e56db3109' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_ThrowsOnInvalidSingle_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel SingleValue='foo' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_LoadsDoubleSuccessfully_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel DoubleValue='-123.456' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                    <SimpleModel DoubleValue='456.789' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT2' ID='2dcf947d-6bc4-4f98-85ae-ca8e56db3109' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_ThrowsOnInvalidDouble_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel DoubleValue='foo' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_LoadsEnumSuccessfully_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel EnumValue='ValueOne' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                    <SimpleModel EnumValue='ValueTwo' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT2' ID='2dcf947d-6bc4-4f98-85ae-ca8e56db3109' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_ThrowsOnInvalidEnum_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel EnumValue='foo' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_LoadsFlagsSuccessfully_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel FlagsValue='ValueOne, ValueThree' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                    <SimpleModel FlagsValue='ValueTwo' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT2' ID='2dcf947d-6bc4-4f98-85ae-ca8e56db3109' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_ThrowsOnInvalidFlags_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel FlagsValue='ValueOne, foo' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_LoadsInheritedValuesSuccessfully_Attribute()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel StringValueOnBaseClass='Hello' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
                    <SimpleModel StringValueOnBaseClass='Goodbye' Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT2' ID='2dcf947d-6bc4-4f98-85ae-ca8e56db3109' />
                </SimpleModels>");
        ...
        public void ObjectLoader_SimpleObject_DefaultsLoadSuccessfully()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <Defaults>
                        <Default Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"'>
        ...
        public void ObjectLoader_SimpleObject_InheritedDefaultsLoadSuccessfully()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <Defaults>
                        <Default Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModelBase, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"'>
                            <StringValue>This is a default!</StringValue>
                        </Default>
                    </Defaults>
                    <SimpleModel Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a' />
        ...
        public void ObjectLoader_SimpleObject_HandlesReservedKeywordsInElements()
        {
            var xml = XDocument.Parse(@"
                <KeywordModels>
                    <KeywordModel Class='Sedulous.Core.Tests.Data.ObjectLoader_ReservedKeywordModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
                        <Constructor>
        ...
        public void ObjectLoader_ConstructorArgs_LoadsSimpleValuesSuccessfully()
        {
            var xml = XDocument.Parse(@"
                <CtorArgModels>
                    <CtorArgModel Class='Sedulous.Core.Tests.Data.ObjectLoader_CtorArgModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
                        <Constructor>
            ...
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
                        <Constructor>
                            <Argument>Hello, world!</Argument>
                            <Argument Type='Sedulous.Core.Tests.Data.ObjectLoader_ComplexRefObjectDerived, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"'>
        ...
        public void ObjectLoader_ConstructorArgs_ThrowsOnNoMatch()
        {
            var xml = XDocument.Parse(@"
                <CtorArgModels>
                    <CtorArgModel Class='Sedulous.Core.Tests.Data.ObjectLoader_CtorArgModelNoMatch, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
                        <Constructor>
                            <Argument>123</Argument>
                            <Argument>456</Argument>
                        </Constructor>
        ...
        public void ObjectLoader_ConstructorArgs_ThrowsOnAmbiguousMatch()
        {
            var xml = XDocument.Parse(@"
                <CtorArgModels>
                    <CtorArgModel Class='Sedulous.Core.Tests.Data.ObjectLoader_CtorArgModelAmbiguousMatch, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
                        <Constructor>
                            <Argument>123</Argument>
                            <Argument>456</Argument>
                        </Constructor>
        ...
        public void ObjectLoader_Indexer_SingleIndexSetsCorrectly()
        {
            var xml = XDocument.Parse(@"
                <IndexerModels>
                    <IndexerModel Class='Sedulous.Core.Tests.Data.ObjectLoader_IndexerModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
                        <Item ix='0'>5</Item>
                        <Item ix='1'>6</Item>
                        <Item ix='3'>8</Item>
                    </IndexerModel>
        ...
        public void ObjectLoader_Indexer_MultipleIndexSetsCorrectly()
        {
            var xml = XDocument.Parse(@"
                <IndexerModels>
                    <IndexerModel Class='Sedulous.Core.Tests.Data.ObjectLoader_MultiIndexerModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
                        <Item x='0' y='0'>5</Item>
                        <Item x='1' y='2'>6</Item>
                        <Item x='3' y='3'>8</Item>
                    </IndexerModel>
        ...
        public void ObjectLoader_Indexer_SingleIndexArraySetsCorrectly()
        {
            var xml = XDocument.Parse(@"
                <IndexerModels>
                    <IndexerModel Class='Sedulous.Core.Tests.Data.ObjectLoader_ArrayIndexerModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
                        <Item ix='1'>
                            <Items>
                                <Item>5</Item>
                                <Item>6</Item>
        ...
        public void ObjectLoader_Indexer_SingleIndexListSetsCorrectly()
        {
            var xml = XDocument.Parse(@"
                <IndexerModels>
                    <IndexerModel Class='Sedulous.Core.Tests.Data.ObjectLoader_ListIndexerModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
                        <Item ix='1'>
                            <Items>
                                <Item>5</Item>
                                <Item>6</Item>
        ...
        public void ObjectLoader_Indexer_ComplexValueSetsCorrectly()
        {
            var xml = XDocument.Parse(@"
                <IndexerModels>
                    <IndexerModel Class='Sedulous.Core.Tests.Data.ObjectLoader_ComplexIndexerModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
                        <Item ix='1'>
                            <X>1</X>
                            <Y>2</Y>
                            <Z>3</Z>
        ...
        public void ObjectLoader_Indexer_ComplexValueSubstitutesTypeCorrectly()
        {
            var xml = XDocument.Parse(@"
                <IndexerModels>
                    <IndexerModel Class='Sedulous.Core.Tests.Data.ObjectLoader_ComplexIndexerModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
                        <Item Type='Sedulous.Core.Tests.Data.ObjectLoader_ComplexRefObjectDerived, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' ix='1'>
                            <X>1</X>
                            <Y>2</Y>
                            <Z>3</Z>
                            <Foobar>baz</Foobar>
        ...
        public void ObjectLoader_Array_PopulatesValues()
        {
            var xml = XDocument.Parse(@"
                <ArrayModels>
                    <ArrayModel Class='Sedulous.Core.Tests.Data.ObjectLoader_ArrayModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
                        <ArrayValue>
                            <Items>
                                <Item>5</Item>
                                <Item>6</Item>
        ...
        public void ObjectLoader_Array_LoadsComplexElements()
        {
            var xml = XDocument.Parse(@"
                <ArrayModels>
                    <ArrayModel Class='Sedulous.Core.Tests.Data.ObjectLoader_ArrayComplexModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
                        <ArrayValue>
                            <Items>
                                <Item>
                                    <X>1</X>
        ...
        public void ObjectLoader_List_PopulatesValues()
        {
            var xml = XDocument.Parse(@"
                <ListModels>
                    <ListModel Class='Sedulous.Core.Tests.Data.ObjectLoader_ListModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
                        <ListValue>
                            <Items>
                                <Item>5</Item>
                                <Item>6</Item>
        ...
        public void ObjectLoader_List_LoadsComplexElements()
        {
            var xml = XDocument.Parse(@"
                <ListModels>
                    <ListModel Class='Sedulous.Core.Tests.Data.ObjectLoader_ListComplexModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
                        <ListValue>
                            <Items>
                                <Item>
                                    <X>1</X>
        ...
        public void ObjectLoader_Enumerable_PopulatesValues()
        {
            var xml = XDocument.Parse(@"
                <EnumerableModels>
                    <EnumerableModel Class='Sedulous.Core.Tests.Data.ObjectLoader_EnumerableModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
                        <EnumerableValue>
                            <Items>
                                <Item>5</Item>
                                <Item>6</Item>
        ...
        public void ObjectLoader_Enumerable_LoadsComplexElements()
        {
            var xml = XDocument.Parse(@"
                <EnumerableModels>
                    <EnumerableModel Class='Sedulous.Core.Tests.Data.ObjectLoader_EnumerableComplexModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
                        <EnumerableValue>
                            <Items>
                                <Item>
                                    <X>1</X>
        ...
        public void ObjectLoader_ComplexObjects_LoadsDerivedReferenceTypesSuccessfully()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
                        <ComplexReference Type='Sedulous.Core.Tests.Data.ObjectLoader_ComplexRefObjectDerived, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"'>
                            <X>1</X>
                            <Y>2</Y>
                            <Z>3</Z>
                            <Foobar>Hello, world!</Foobar>
        ...
        public void ObjectLoader_ComplexObjects_ThrowsIfLoadingIncompatibleType()
        {
            var xml = XDocument.Parse(@"
                <SimpleModels>
                    <SimpleModel Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
                        <ComplexReference Type='Sedulous.Core.Tests.Data.ObjectLoader_ComplexRefObjectNotDerived, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"'>
                            <X>1</X>
                            <Y>2</Y>
                            <Z>3</Z>
                            <Foobar>Hello, world!</Foobar>
        ...
        public void ObjectLoader_ComplexObjects_LoadsComplexListsSuccessfully()
        {
            var xml = XDocument.Parse(@"
                <ListModels>
                    <ListModel Class='Sedulous.Core.Tests.Data.ObjectLoader_SimpleModel, " + typeof(ObjectLoaderTest).Assembly.GetName().Name + @"' Key='OBJECT1' ID='6610e29a-57b3-4960-8f40-1466ee82f40a'>
                        <ComplexList>
                            <X>1</X>
                            <Y>2</Y>
                            <Z>3</Z>

...
namespace Sedulous
{
    ...
    /// </summary>
    internal class SedulousApplicationWindowSettings
    {
        /// <summary>
        ...
        public static XElement Save(SedulousApplicationWindowSettings settings)
        {
        ...
        public static SedulousApplicationWindowSettings Load(XElement xml)
        {
            if (xml == null)
                return null;
            ...
            try
            {
                var settings = new SedulousApplicationWindowSettings();
        ...
        public static SedulousApplicationWindowSettings FromCurrentSettings(SedulousContext uv)
        {

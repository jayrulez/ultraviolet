...
namespace Sedulous
{
    ...
    /// </summary>
    internal class SedulousApplicationAudioSettings
    {
        /// <summary>
        ...
        public static XElement Save(SedulousApplicationAudioSettings settings)
        {
        ...
        public static SedulousApplicationAudioSettings Load(XElement xml)
        {
            if (xml == null)
                return null;
            ...
            try
            {
                var settings = new SedulousApplicationAudioSettings();
        ...
        public static SedulousApplicationAudioSettings FromCurrentSettings(SedulousContext uv)
        {

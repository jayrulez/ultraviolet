...
{
    /// <summary>
    /// Contains the Sedulous Presentation Foundation expression compiler's string resources.
    /// </summary>
    public static class CompilerStrings
    {
        ...
        static CompilerStrings()
        {
            ...
            using (var stream = asm.GetManifestResourceStream("Sedulous.Presentation.Compiler.Resources.Strings.xml"))
            {

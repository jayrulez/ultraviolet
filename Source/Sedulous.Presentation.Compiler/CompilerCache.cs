...
namespace Sedulous.Presentation.Compiler
{
    ...
    internal class CompilerCache
    {
        ...
        {
            versionSedulous = FileVersionInfo.GetVersionInfo(typeof(CompilerCache).Assembly.Location).FileVersion;
        ...
        public static CompilerCache FromFile(String path)
        {
            ...
            var versionSedulous = default(String);
            ...
            for(int i = 0; i < lines.Length; i++)
            {
                ...
                if (versionSedulous == default(String))
                {
                    versionSedulous = line;
                    continue;
                }
            ...
            cache.versionSedulous = versionSedulous;
        ...
        public void Save(String path)
        {
            ...
            using (var writer = new StreamWriter(stream))
            {
                ...
                writer.WriteLine(versionSedulous);
        ...
        public Boolean IsDifferentFrom(CompilerCache other)
        {
            ...
            if (!String.Equals(versionSedulous, other.versionSedulous, StringComparison.Ordinal) ||
        ...
        private static void AddTypeReferences(Type info, ISet<Type> refs)
        {
            ...
            if (info.Assembly == typeof(Object).Assembly ||
                ...
                info.Assembly.FullName.StartsWith("Sedulous."))
            {
                return;
            }
        ...
        private String versionSedulous;

...
namespace Sedulous.OpenGL
{
    ...
    public class OpenGLGraphicsConfiguration : FrameworkGraphicsConfiguration
    {
        ...
        /// This cannot be lower than the minimum version required by Sedulous itself.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether Sedulous should attempt to use buffer mapping when

...
{
    /// <summary>
    /// Contains the Sedulous OpenGL binding library's string resources.
    /// </summary>
    public static class BindingsStrings
    {
        ...
        static BindingsStrings()
        {
            ...
            using (var stream = asm.GetManifestResourceStream("Sedulous.OpenGL.Bindings.Resources.Strings.xml"))
            {

...
{
    /// <summary>
    /// Represents the Sedulous Framework's configuration settings.
    /// </summary>
    public class SedulousConfiguration
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SedulousConfiguration"/> class.
        /// </summary>
        public SedulousConfiguration()
        {
            Plugins = new SedulousPluginCollection(this);
        ...
        /// </summary>
        public SedulousPluginCollection Plugins { get; }

        /// <summary>
        /// Gets or sets the Sedulous context's graphics configuration settings.
        /// </summary>
        public SedulousGraphicsConfiguration GraphicsConfiguration { get; set; }
        ...
        /// creating and managing instances of the <see cref="Sedulous.UI.UIView"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether Sedulous should watch view definition files
        ...
        /// still exists.</para>
        /// <para>This mode is primarily useful in circumstances where an Sedulous-based application has to run in the context of a

...
namespace Sedulous
{
    ...
    /// </summary>
    public interface ISedulousAudio : ISedulousSubsystem
    {
        /// <summary>
        ...
        IEnumerable<ISedulousAudioDevice> EnumerateAudioDevices();
        ...
        ISedulousAudioDevice FindAudioDeviceByName(String name);
        ...
        /// </summary>
        ISedulousAudioDevice PlaybackDevice { get; set; }

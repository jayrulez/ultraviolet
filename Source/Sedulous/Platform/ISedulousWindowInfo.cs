...
namespace Sedulous.Platform
{
    ...
    public delegate void SedulousWindowInfoEventHandler(ISedulousWindow window);

    /// <summary>
    /// Provides access to information concerning the context's attached windows.
    /// </summary>
    public interface ISedulousWindowInfo : IEnumerable<ISedulousWindow>
    {
        /// <summary>
        ...
        void DesignatePrimary(ISedulousWindow window);
        ...
        ISedulousWindow GetByID(Int32 id);
        ...
        ISedulousWindow Create(String caption, Int32 x, Int32 y, Int32 width, Int32 height, WindowFlags flags = WindowFlags.None);
        ...
        /// <returns>The Sedulous window that was created.</returns>
        ISedulousWindow CreateFromNativePointer(IntPtr ptr);
        ...
        Boolean Destroy(ISedulousWindow window);
        ...
        new List<ISedulousWindow>.Enumerator GetEnumerator();

...
namespace Sedulous.Platform
{
    ...
    public delegate void SedulousWindowEventHandler(ISedulousWindow window);
    ...
    public delegate void SedulousWindowDrawingEventHandler(ISedulousWindow window, SedulousTime time);

    /// <summary>
    /// Represents a window that is attached to an Sedulous context.
    /// </summary>
    public interface ISedulousWindow
    {
        /// <summary>
        ...
        void ChangeDisplay(ISedulousDisplay display);

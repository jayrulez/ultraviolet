...
namespace Sedulous.Content
{
    ...
    /// </summary>
    [CLSCompliant(false)]
    public static class SedulousDataObjectRegistries
    {
        /// <summary>
        ...
        /// <returns>The <see cref="SedulousDataObjectRegistry{T}"/> which contains objects of type <typeparamref name="T"/>.</returns>
        public static SedulousDataObjectRegistry<T> Get<T>() where T : SedulousDataObject =>
            (SedulousDataObjectRegistry<T>)DataObjectRegistries.Get<T>();
        ...
        public static void Unregister<T>() where T : SedulousDataObject =>

...
namespace Sedulous.Content
{
    ...
    /// </summary>
    [CLSCompliant(false)]
    public static class FrameworkDataObjectRegistries
    {
        /// <summary>
        ...
        /// <returns>The <see cref="FrameworkDataObjectRegistry{T}"/> which contains objects of type <typeparamref name="T"/>.</returns>
        public static FrameworkDataObjectRegistry<T> Get<T>() where T : FrameworkDataObject =>
            (FrameworkDataObjectRegistry<T>)DataObjectRegistries.Get<T>();
        ...
        public static void Unregister<T>() where T : FrameworkDataObject =>

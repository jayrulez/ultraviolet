...
namespace Sedulous
{
    ...
    /// </summary>
    public sealed partial class SedulousTimingLogic : ISedulousTimingLogic
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SedulousTimingLogic"/> class.
        /// </summary>
        /// <param name="host">The Sedulous host.</param>
        public SedulousTimingLogic(ISedulousHost host)
        {
        ...
        public void RunOneTick()
        {
            ...
            if (SynchronizationContext.Current is SedulousSynchronizationContext syncContext)
            ...
            if (!host.IsSuspended)
            {
                ...
                using (SedulousProfiler.Section(SedulousProfilerSections.Draw))
                {
                    uv.Draw(drawTime);
                }
            }
        ...
        private Boolean UpdateContext(SedulousContext uv, SedulousTime time)
        {
            using (SedulousProfiler.Section(SedulousProfilerSections.Update))
            {
                uv.Update(time);
            }
            return !uv.Disposed;
        ...
        private readonly SedulousTimeTracker timeTrackerUpdate = new SedulousTimeTracker();
        private readonly SedulousTimeTracker timeTrackerDraw = new SedulousTimeTracker();

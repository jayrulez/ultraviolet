...
namespace Sedulous
{
    ...
    public abstract class SedulousNamedCollection<T> : SedulousCollection<T>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SedulousNamedCollection{T}"/> class.
        /// </summary>
        protected SedulousNamedCollection()
        {
        ...
        protected SedulousNamedCollection(Int32 capacity)
            : base(capacity)
        {
        ...
        /// <summary>
        /// Gets a collection containing the keys in the <see cref="Sedulous.SedulousNamedCollection{T}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets a collection containing the values in the <see cref="Sedulous.SedulousNamedCollection{T}"/>.
        /// </summary>
        ...
        protected override void AddInternal(T item)
        {
            ...
            if (name == null)
            {
                throw new InvalidOperationException(SedulousStrings.InvalidNamedCollectionName);
            }

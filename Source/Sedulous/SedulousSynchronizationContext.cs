...
namespace Sedulous
{
    ...
    /// </summary>
    public sealed class SedulousSynchronizationContext : SynchronizationContext
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SedulousSynchronizationContext"/> class.
        /// </summary>
        /// <param name="uv">The Sedulous context.</param>
        internal SedulousSynchronizationContext(SedulousContext uv)
        {
        ...
        {
            return new SedulousSynchronizationContext(Sedulous);
        }

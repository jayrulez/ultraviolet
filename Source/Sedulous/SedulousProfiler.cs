...
namespace Sedulous
{
    ...
    /// </summary>
    public static class SedulousProfiler
    {
        /// <summary>
        /// Creates an <see cref="SedulousProfilerSection"/> object which represents a profiler section
        /// and immediately begins that section.
        /// </summary>
        /// <param name="name">The name of the profiler section.</param>
        /// <returns>The <see cref="SedulousProfilerSection"/> object which was created.</returns>
        public static SedulousProfilerSection Section(String name)
        {
            var section = new SedulousProfilerSection(name);
            BeginSection(name);
            return section;
        }
        ...
        public static void TakeSnapshotOfNextFrame()
        {
            ...
            if (impl == null)
                throw new InvalidOperationException(SedulousStrings.ContextDoesNotHaveProfiler);
        ...
        /// </summary>
        private static readonly SedulousSingleton<SedulousProfilerBase> instance =
            new SedulousSingleton<SedulousProfilerBase>(uv =>
            {

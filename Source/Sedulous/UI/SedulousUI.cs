...
namespace Sedulous.UI
{
    ...
    /// </summary>
    public sealed class SedulousUI : SedulousResource, ISedulousUI
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SedulousUI"/> class.
        /// </summary>
        /// <param name="uv">The Sedulous context.</param>
        /// <param name="configuration">The Sedulous Framework configuration settings for the current context.</param>
        public SedulousUI(SedulousContext uv, SedulousConfiguration configuration)
            : base(uv)
        {
        ...
        /// <inheritdoc/>
        public UIScreenStack GetScreens(ISedulousWindow window)
        {
            Contract.EnsureNotDisposed(this, Disposed);

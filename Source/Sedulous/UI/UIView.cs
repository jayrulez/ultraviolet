...
namespace Sedulous.UI
{
    ...
    public delegate UIView UIViewFactory(FrameworkContext context, UIPanel uiPanel, UIPanelDefinition uiPanelDefinition, UIViewModelFactory vmfactory);
    ...
    public abstract class UIView : FrameworkResource
    {
        ...
        /// by Sedulous itself and corresponds to the <see cref="UIPanel.IsReadyForInput"/> property on the panel that owns the view.</remarks>

...
namespace Sedulous
{
    ...
    /// </summary>
    public interface ISedulousPlatform : ISedulousSubsystem
    {
        /// <summary>
        ...
        void InitializePrimaryWindow(SedulousConfiguration configuration);
        ...
        void ShowMessageBox(MessageBoxType type, String title, String message, ISedulousWindow parent = null);
        ...
        /// </summary>
        ISedulousWindowInfo Windows { get; }

        /// <summary>
        /// Gets the display information manager.
        /// </summary>
        ISedulousDisplayInfo Displays { get; }
    }
}

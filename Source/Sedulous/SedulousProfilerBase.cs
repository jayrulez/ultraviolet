...
{
    /// <summary>
    /// Represents a factory method which constructs instances of the <see cref="SedulousProfilerBase"/> class.
    /// </summary>
    /// <param name="uv">The Sedulous context.</param>
    /// <returns>The instance of <see cref="SedulousProfilerBase"/> that was created.</returns>
    public delegate SedulousProfilerBase SedulousProfilerFactory(SedulousContext uv);

    /// <summary>
    /// Represents the base class for Sedulous profilers.
    /// </summary>
    public abstract class SedulousProfilerBase : SedulousResource
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SedulousProfilerBase"/> class.
        /// </summary>
        /// <param name="uv">The Sedulous context.</param>
        public SedulousProfilerBase(SedulousContext uv)
            : base(uv)
        {

...
namespace Sedulous
{
    ...
    public abstract partial class FrameworkCollection<T> : IEnumerable<T>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FrameworkCollection{T}"/> class.
        /// </summary>
        protected FrameworkCollection()
        {
        ...
        protected FrameworkCollection(Int32 capacity)
        {

...
namespace Sedulous
{
    ...
    /// </summary>
    public static class SedulousProfilerSections
    {        
        /// <summary>
        ...
        /// <summary>
        /// Identifies the profiler section that starts at the beginning of <see cref="SedulousContext.Draw(SedulousTime)"/> and
        /// ends and the end of that method.
        /// </summary>
        public const String Draw = "UV_Draw";

        /// <summary>
        /// Identifies the profiler section that starts at the beginning of <see cref="SedulousContext.Update(SedulousTime)"/> and
        /// ends and the end of that method.
        /// </summary>

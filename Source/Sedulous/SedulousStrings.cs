...
{
    /// <summary>
    /// Contains Sedulous's string resources.
    /// </summary>
    public static class SedulousStrings
    {
        /// <summary>
        /// Initializes the <see cref="SedulousStrings"/> type.
        /// </summary>
        static SedulousStrings()
        {
            var asm = Assembly.GetExecutingAssembly();
            using (var stream = asm.GetManifestResourceStream("Sedulous.Resources.Strings.xml"))
            {
                StringDatabase.LoadFromStream(stream);
            }
            using (var stream = asm.GetManifestResourceStream("Sedulous.Resources.Bindings.xml"))
            {

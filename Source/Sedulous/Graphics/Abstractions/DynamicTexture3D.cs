...
namespace Sedulous.Graphics
{
    ...
    public delegate DynamicTexture3D DynamicTexture3DFactory(FrameworkContext context, Int32 width, Int32 height, Int32 depth, TextureOptions options, Object state, Action<Texture3D, Object> flushed);
    ...
    public abstract class DynamicTexture3D : Texture3D
    {
        ...
        /// <param name="state">An arbitrary state object which will be passed to the flush handler.</param>
        /// <param name="flushed">The handler to invoke when the texture is flushed.</param>
        protected DynamicTexture3D(FrameworkContext context, Int32 width, Int32 height, Int32 depth, TextureOptions options, Object state, Action<Texture3D, Object> flushed)
            : base(context)
        {

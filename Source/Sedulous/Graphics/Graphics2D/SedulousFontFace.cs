...
namespace Sedulous.Graphics.Graphics2D
{
    ...
    /// </summary>
    public abstract class SedulousFontFace : SedulousResource
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SedulousFontFace"/> class.
        /// </summary>
        /// <param name="uv">The Sedulous context.</param>
        public SedulousFontFace(SedulousContext uv)
            : base(uv)
        { }

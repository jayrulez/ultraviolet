...
{
    /// <summary>
    /// Represents a 96-bit packed vector consisting of 3 32-bit values.
    /// </summary>
    [StructLayout(LayoutKind.Explicit, Pack = 0, Size = sizeof(UInt32) * 3)]
    public partial struct Int3
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Int3"/> structure from the specified vector.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Int3"/> structure from the specified vector components.
        /// </summary>
        ...
        public Int3(Single x, Single y, Single z)
        {
        ...
        /// <summary>
        /// Converts the <see cref="Int3"/> instance to a <see cref="Vector3"/> instance.
        /// </summary>

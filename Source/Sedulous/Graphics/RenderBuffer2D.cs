...
namespace Sedulous.Graphics
{
    ...
    public delegate RenderBuffer2D RenderBuffer2DFactory(FrameworkContext context, RenderBufferFormat format, Int32 width, Int32 height, RenderBufferOptions options);

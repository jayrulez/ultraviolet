...
{
    /// <summary>
    /// Represents a dummy implementation of <see cref="IGraphicsSubsystem"/>.
    /// </summary>
    public sealed class DummyGraphicsSubsystem : FrameworkResource, IGraphicsSubsystem
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DummyGraphicsSubsystem"/> class.
        /// </summary>
        /// <param name="uv">The Sedulous context.</param>
        public DummyGraphicsSubsystem(FrameworkContext uv)
            : base(uv)
        {

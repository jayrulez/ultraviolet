...
namespace Sedulous.Graphics.Graphics3D
{
        ...
        where TModel : Model
    {
        ...
        /// <summary>
        /// Converts a <see cref="SharpGLTF.Schema2.PrimitiveType"/> value to an Sedulous <see cref="PrimitiveType"/> value.
        /// </summary>
        ...
        private static ModelMesh ProcessNodeMesh(ContentManager contentManager, Mesh mesh, GltfMaterialLoader materialLoader)
        {
            ...
            {
                // There is no way to correspond mesh.Primitives with decoder.Primitives
                // Assuming they share the same index

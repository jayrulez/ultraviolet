...
namespace Sedulous.Graphics.Graphics3D
{
    ...
    public class SkinnedModel : Model
    {
        ...
        public SkinnedModel(SedulousContext uv, IList<ModelScene> scenes, IList<Texture2D> textures, IEnumerable<Skin> skins, IEnumerable<SkinnedAnimation> animations)

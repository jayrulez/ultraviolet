...
namespace Sedulous
{
    ...
    public abstract partial class SedulousCollection<T> : IEnumerable<T>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SedulousCollection{T}"/> class.
        /// </summary>
        protected SedulousCollection()
        {
        ...
        protected SedulousCollection(Int32 capacity)
        {

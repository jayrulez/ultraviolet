...
{
    /// <summary>
    /// Represents a dummy implementation of <see cref="ISedulousGraphics"/>.
    /// </summary>
    public sealed class DummySedulousGraphics : SedulousResource, ISedulousGraphics
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DummySedulousGraphics"/> class.
        /// </summary>
        /// <param name="uv">The Sedulous context.</param>
        public DummySedulousGraphics(SedulousContext uv)
            : base(uv)
        {

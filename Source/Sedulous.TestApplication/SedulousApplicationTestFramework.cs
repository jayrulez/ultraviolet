...
namespace Sedulous.TestApplication
{
    ...
    /// </summary>
    public abstract class SedulousApplicationTestFramework : SedulousTestFramework
    {
        /// <summary>
        ...
        protected static void DestroySedulousApplication(ISedulousTestApplication application)
        {
            try
            {
                if (application != null)
            ...
            catch (Exception e1)
            {
                try
                {
                    var context = (SedulousContext)typeof(SedulousContext).GetField("current",
        ...
        protected static ISedulousTestApplication GivenAThrowawaySedulousApplication()
        {
            return new SedulousTestApplication();
        }
        ...
        /// </summary>
        /// <returns>The test application that was created.</returns>
        protected static ISedulousTestApplication GivenAThrowawaySedulousApplicationWithNoWindow()
        {
            return new SedulousTestApplication(true);
        }
        ...
        /// </summary>
        /// <returns>The test application that was created.</returns>
        protected ISedulousTestApplication GivenAnSedulousApplication()
        {
            if (application != null)
                throw new InvalidOperationException("An application has already been created.");

            application = new SedulousTestApplication();
        ...
        /// </summary>
        /// <returns>The test application that was created.</returns>
        protected ISedulousTestApplication GivenAnSedulousApplicationWithNoWindow()
        {
            if (application != null)
                throw new InvalidOperationException("An application has already been created.");

            application = new SedulousTestApplication(headless: true);
        ...
        /// </summary>
        /// <returns>The test application that was created.</returns>
        protected ISedulousTestApplication GivenAnSedulousApplicationInServiceMode()
        {
            if (application != null)
                throw new InvalidOperationException("An application has already been created.");

            application = new SedulousTestApplication(headless: true, serviceMode: true);
        ...
        // State values.
        private SedulousTestApplication application;
    }
}
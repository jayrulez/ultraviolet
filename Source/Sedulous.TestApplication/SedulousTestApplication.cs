...
namespace Sedulous.TestApplication
{
    ...
    /// </summary>
    public partial class SedulousTestApplication : SedulousApplication, ISedulousTestApplication
    {
        /// <summary>
        ...
        public SedulousTestApplication(Boolean headless = false, Boolean serviceMode = false)
        ...
        /// <inheritdoc/>
        public ISedulousTestApplication WithAudioImplementation(AudioImplementation audioImplementation)
        {
        ...
        /// <inheritdoc/>
        public ISedulousTestApplication WithConfiguration(Action<SedulousConfiguration> configurer)
        {
        ...
        /// <inheritdoc/>
        public ISedulousTestApplication WithPlugin(SedulousPlugin plugin)
        {
            if (plugin == null)
                return this;

            if (this.plugins == null)
                this.plugins = new List<SedulousPlugin>();
        ...
        /// <inheritdoc/>
        public ISedulousTestApplication WithInitialization(Action<SedulousContext> initializer)
        {
        ...
        /// <inheritdoc/>
        public ISedulousTestApplication WithContent(Action<ContentManager> loader)
        {
        ...
        /// <inheritdoc/>
        public ISedulousTestApplication WithDispose(Action disposer)
        {
        ...
        /// <inheritdoc/>
        public ISedulousTestApplication SkipFrames(Int32 frameCount)
        {
        ...
        /// <inheritdoc/>
        public ISedulousTestApplication OnFrameStart(Int32 frame, Action<ISedulousTestApplication> action)
        {
        ...
        /// <inheritdoc/>
        public ISedulousTestApplication OnUpdate(Action<ISedulousTestApplication, SedulousTime> action)
        {
            if (frameActions == null)
                frameActions = new List<FrameAction>();
        ...
        /// <inheritdoc/>
        public ISedulousTestApplication OnUpdate(Int32 update, Action<ISedulousTestApplication, SedulousTime> action)
        {
            if (frameActions == null)
                frameActions = new List<FrameAction>();
        ...
        /// <inheritdoc/>
        public ISedulousTestApplication OnRender(Action<ISedulousTestApplication, SedulousTime> action)
        {
            if (frameActions == null)
                frameActions = new List<FrameAction>();
        ...
        /// <inheritdoc/>
        public ISedulousTestApplication OnRender(Int32 render, Action<ISedulousTestApplication, SedulousTime> action)
        {
            if (frameActions == null)
                frameActions = new List<FrameAction>();
        ...
        /// <inheritdoc/>
        public StbImageSharp.ImageResult Render(Action<SedulousContext> renderer)
        {
            if (headless)
        ...
        public void SpoofKeyDown(Scancode scancode, Key key, Boolean ctrl, Boolean alt, Boolean shift)
        {
            ...
            Sedulous.Messages.Publish(SDL2SedulousMessages.SDLEvent, data);
        }
        ...
        protected override SedulousContext OnCreatingSedulousContext()
        {
            ...
            {
                plugins = plugins ?? new List<SedulousPlugin>();
        ...
        /// </summary>
        private void RunFrameActions(FrameActionType actionType, Int32 actionIndex, SedulousTime time)
        {
            if (frameActions == null)
                return;
            ...
            foreach (var action in actions)
            {
                switch (actionType)
                {
                    case FrameActionType.FrameStart:
                        ((Action<ISedulousTestApplication>)action.Action)(this);
                        break;

                    default:
                        ((Action<ISedulousTestApplication, SedulousTime>)action.Action)(this, time);
                        break;
                }
            }
        }
        ...
        private Action<SedulousConfiguration> configurer;
        private Action<SedulousContext> initializer;
        private Action<ContentManager> loader;
        private Action<SedulousContext> renderer;
        ...
        private List<SedulousPlugin> plugins;

...
namespace Sedulous.Windows.Forms
{
    ...
    /// </summary>
    public partial class SedulousForm : Form, ISedulousHost
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        public ISedulousPlatformCompatibilityShim CompatibilityShim { get; } = new WindowsFormSedulousPlatformCompatibilityShim();
        ...
        protected virtual SedulousContext OnCreatingSedulousContext()
        {
            return null;
        }

...
namespace Sedulous
{
    ...
    /// </summary>
    public abstract class SedulousApplication : SDLActivity,
        ...
        IDisposable
    {
        ...
        protected SedulousApplication(String developerName, String applicationName)
        {
            ...
            this.CompatibilityShim = new AndroidSedulousPlatformCompatibilityShim();
        }
        ...
        public override void OnConfigurationChanged(Android.Content.Res.Configuration newConfig)
        {
            if (Sedulous != null && !Sedulous.Disposed)
            {
                ...
                if (rotation != display.Rotation)
                {
                    ...
                    Sedulous.Messages.Publish(SedulousMessages.OrientationChanged, messageData);
                }
            }
        ...
        /// <summary>
        /// Gets the current instance of the <see cref="SedulousApplication"/> class.
        /// </summary>
        internal static SedulousApplication Instance
        {
            get { return MSingleton as SedulousApplication; }
        }
        ...
        {
            if (type == SedulousMessages.ApplicationTerminating || type == SedulousMessages.Quit)
            {
                running = false;
            }

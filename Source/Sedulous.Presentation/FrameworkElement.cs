...
namespace Sedulous.Presentation
{
    ...
    /// <summary>
    /// Represents the base class for standard Sedulous Presentation Foundation elements.
    /// </summary>
    [UvmlKnownType]
    public abstract class FrameworkElement : UIElement, ISupportInitialize
    {
        ...
        /// </summary>
        /// <remarks>The Sedulous Presentation Foundation does not currently implement the same templating

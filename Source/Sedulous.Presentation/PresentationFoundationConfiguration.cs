...
{
    /// <summary>
    /// Represents the configuration settings for the Sedulous Presentation Foundation.
    /// </summary>
    public sealed class PresentationFoundationConfiguration
    {
        ...
        public PresentationFoundationConfiguration()
        {
            ...
            BindingExpressionCompilerAssembly = String.Format("Sedulous.Presentation.Compiler, Version={0}, Culture=neutral, PublicKeyToken=78da2f4877323311, processorArchitecture=MSIL", version);
        }

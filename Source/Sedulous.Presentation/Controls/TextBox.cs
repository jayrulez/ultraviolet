...
namespace Sedulous.Presentation.Controls
{
    ...
    /// </summary>
    [UvmlKnownType(null, "Sedulous.Presentation.Controls.Templates.TextBox.xml")]
    ...
    public class TextBox : TextBoxBase
    {
        ...
        /// </summary>
        /// <value>A <see cref="Sedulous.Input.KeyboardMode"/> value which determines the kind of software keyboard
        /// which is displayed by this text box on platforms which use software keyboard. The default
        /// value is <see cref="Sedulous.Input.KeyboardMode.Text"/>.</value>
        /// <remarks>
        /// <dprop>

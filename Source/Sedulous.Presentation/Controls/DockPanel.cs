...
namespace Sedulous.Presentation.Controls
{
    ...
    /// </summary>
    [UvmlKnownType(null, "Sedulous.Presentation.Controls.Templates.DockPanel.xml")]
    public class DockPanel : Panel
    {
        ...
        public DockPanel(FrameworkContext context, String name)
            : base(context, name)
        {
        ...
        /// <summary>
        /// Identifies the <see cref="P:Sedulous.Presentation.Controls.DockPanel.Dock"/>
        /// attached property.
        /// </summary>
        /// <value>The identifier for the <see cref="P:Sedulous.Presentation.Controls.DockPanel.Dock"/>

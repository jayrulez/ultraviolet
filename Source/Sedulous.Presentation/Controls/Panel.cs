...
namespace Sedulous.Presentation.Controls
{
    ...
    public abstract class Panel : FrameworkElement
    {
        ...
        public Panel(FrameworkContext context, String name)
            : base(context, name)
        {
        ...
        /// <summary>
        /// Identifies the <see cref="P:Sedulous.Presentation.Controls.Panel.ZIndex"/>
        /// attached property.
        /// </summary>
        /// <value>The identifier for the <see cref="P:Sedulous.Presentation.Controls.Panel.ZIndex"/>

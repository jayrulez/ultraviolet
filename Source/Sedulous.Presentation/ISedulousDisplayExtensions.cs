...
{
    /// <summary>
    /// Contains extension methods for the <see cref="ISedulousDisplay"/> interface.
    /// </summary>
    public static class ISedulousDisplayExtensions
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="this">The <see cref="ISedulousDisplay"/> with which to perform the conversion.</param>
        ...
        public static Thickness InchesToPixels(this ISedulousDisplay @this, Thickness inches)
        {
        ...
        public static Thickness PixelsToInches(this ISedulousDisplay @this, Thickness pixels)
        {
            Contract.Require(@this, "this");
        ...
        /// <returns>The converted <see cref="Thickness"/> in display pixels.</returns>
        public static Thickness DipsToPixels(this ISedulousDisplay @this, Thickness dips)
        {
            Contract.Require(@this, "this");
        ...
        public static Thickness PixelsToDips(this ISedulousDisplay @this, Thickness pixels)
        {
            Contract.Require(@this, "this");
        ...
        /// <param name="inches">The <see cref="Thickness"/> in inches to convert.</param>
        /// <returns>The converted <see cref="Thickness"/> in display independent pixels.</returns>
        public static Thickness InchesToDips(this ISedulousDisplay @this, Thickness inches)
        {
            Contract.Require(@this, "this");
        ...
        /// <param name="dips">The <see cref="Thickness"/> in display independent pixels to convert.</param>
        /// <returns>The converted <see cref="Thickness"/> in inches.</returns>
        public static Thickness DipsToInches(this ISedulousDisplay @this, Thickness dips)
        {
            Contract.Require(@this, "this");
        ...
        public static Matrix DipsToPixels(this ISedulousDisplay @this, Matrix matrix)
        {
        ...
        public static void DipsToPixels(this ISedulousDisplay @this, ref Matrix matrix, out Matrix result)
        {
            var x = (Single)@this.DipsToPixels(matrix.M14);
            var y = (Single)@this.DipsToPixels(matrix.M24);
            var z = (Single)@this.DipsToPixels(matrix.M34);

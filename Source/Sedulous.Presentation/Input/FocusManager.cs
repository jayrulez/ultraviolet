...
namespace Sedulous.Presentation.Input
{
    ...
    public static class FocusManager
    {
        ...
        /// <summary>
        /// Adds a handler for the <see cref="E:Sedulous.Presentation.Input.FocusManager.GotFocus"/> 
        ...
        /// <summary>
        /// Adds a handler for the <see cref="E:Sedulous.Presentation.Input.FocusManager.LostFocus"/> 
        /// attached event to the specified element.
        /// </summary>
        /// <param name="element">The element to which to add the handler.</param>
        /// <param name="handler">The handler to add to the specified element.</param>
        ...
        /// <summary>
        /// Removes a handler for the <see cref="E:Sedulous.Presentation.Input.FocusManager.GotFocus"/> 
        ...
        /// <summary>
        /// Removes a handler for the <see cref="E:Sedulous.Presentation.Input.FocusManager.LostFocus"/> 
        /// attached event from the specified element.
        /// </summary>
        /// <param name="element">The element from which to remove the handler.</param>
        /// <param name="handler">The handler to remove from the specified element.</param>
        ...
        /// <summary>
        /// Identifies the <see cref="P:Sedulous.Presentation.Input.FocusManager.FocusedElement"/> attached property.
        /// </summary>
        /// <value>The identifier for the <see cref="P:Sedulous.Presentation.Input.FocusManager.FocusedElement"/> attached property.</value>
        ...
        /// <summary>
        /// Identifies the <see cref="P:Sedulous.Presentation.Input.FocusManager.IsFocusScope"/> attached property.
        /// </summary>
        /// <value>The identifier for the <see cref="P:Sedulous.Presentation.Input.FocusManager.IsFocusScope"/> attached property.</value>
        /// <AttachedPropertyComments>
        /// <summary>
        ...
        /// <summary>
        /// Identifies the <see cref="E:Sedulous.Presentation.Input.FocusManager.GotFocus"/> 
        /// attached routed event.
        /// </summary>
        /// <value>The identifier of the <see cref="E:Sedulous.Presentation.Input.FocusManager.GotFocus"/>
        ...
        /// <summary>
        /// Identifies the <see cref="E:Sedulous.Presentation.Input.FocusManager.LostFocus"/> 
        /// attached routed event.
        /// </summary>
        /// <value>The identifier of the <see cref="E:Sedulous.Presentation.Input.FocusManager.LostFocus"/>
        /// attached routed event.</value>
        /// <AttachedEventComments>
        /// <summary>
        ...
        /// <summary>
        /// Occurs when the value of the <see cref="P:Sedulous.Presentation.Input.FocusManager.FocusedElement"/>

...
namespace Sedulous.Presentation.Uvss
{
    /// <summary>
    /// Represents an Sedulous StyleSheets (UVSS) lexer which takes a raw string as its input and produces a 
    ...
    public class UvssLexer
    {
        ...
        /// <summary>
        /// Tokenizes the specified Sedulous StyleSheets (UVSS) string.
        /// </summary>

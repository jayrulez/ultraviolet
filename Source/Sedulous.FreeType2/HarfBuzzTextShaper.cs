...
using static Sedulous.FreeType2.Native.HarfBuzzNative;
...
namespace Sedulous.FreeType2
{
    ...
    public sealed class HarfBuzzTextShaper : TextShaper
    {
        ...
        {
            var hbdir = TextDirectionUtil.SedulousToHarfBuzz(direction);
        ...
        {
            var hbscript = TextScriptUtil.SedulousToHarfBuzz(script);

...
namespace Sedulous.FreeType2
{
    ...
    public sealed class FreeTypeFont : FrameworkFont<FreeTypeFontFace>
    {
        ...
        public FreeTypeFont(FrameworkContext uv, FreeTypeFontFace face)
        ...
        public FreeTypeFont(FrameworkContext uv, FreeTypeFontFace regular, FreeTypeFontFace bold, FreeTypeFontFace italic, FreeTypeFontFace boldItalic)

...
namespace Sedulous.FreeType2
{
    ...
    /// </summary>
    [ContentProcessor]
    public sealed class SedulousFontProcessorFromJObject : ContentProcessor<JObject, SedulousFont>
    {
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public override SedulousFont Process(ContentManager manager, IContentProcessorMetadata metadata, JObject input) =>
        ...
        {
            var impl = SedulousContext.DemandCurrent().GetContent().Processors.FindProcessor(typeof(JObject), typeof(SpriteFont));
            if (impl == null)

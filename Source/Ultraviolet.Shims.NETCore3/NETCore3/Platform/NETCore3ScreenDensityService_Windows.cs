...
namespace Ultraviolet.Shims.NETCore3.Platform
{
    ...
    /// </summary>
    public sealed partial class NETCore3ScreenDensityService_Windows : ScreenDensityService
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NETCore3ScreenDensityService_Windows"/> class.
        /// </summary>
        /// <param name="uv">The Ultraviolet context.</param>
        /// <param name="display">The <see cref="IUltravioletDisplay"/> for which to retrieve density information.</param>
        public NETCore3ScreenDensityService_Windows(UltravioletContext uv, IUltravioletDisplay display)
            : base(display)
        {

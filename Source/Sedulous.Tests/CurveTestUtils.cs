...
namespace Sedulous.Tests
{
    ...
    public static class CurveTestUtils
    {
        ...
        /// </summary>
        public static Curve<TValue, CurveKey<TValue>> ReadCurveFromCsv<TValue>(String path, Sedulous.ICurveSampler<TValue, CurveKey<TValue>> sampler)
            where TValue : new()
        {
        ...
        /// Reads a curve from the specified CSV file.
        /// </summary>
        public static Curve<TValue, CubicSplineCurveKey<TValue>> ReadCurveFromCsv<TValue>(String path, Sedulous.ICurveSampler<TValue, CubicSplineCurveKey<TValue>> sampler)
            where TValue : new()
        {
            using (var file = File.OpenRead(path))
            using (var reader = new StreamReader(file))
        ...
        /// <summary>
        /// Creates a SharpGLTF curve sampler for the specified Sedulous curve.
        /// </summary>

#includeres "Sedulous.OpenGL.Resources.SkinnedEffectPreamble.glsl" executing
...
void main()
{
    ...
    Skin(position, normal, uv_BlendIndices0, uv_BlendWeight0, 1);

	CommonVSOutputPixelLighting  cout = ComputeCommonVSOutputPixelLighting(position, normal);

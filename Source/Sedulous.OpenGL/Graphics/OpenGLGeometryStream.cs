...
namespace Sedulous.OpenGL.Graphics
{
    ...
    public sealed partial class OpenGLGeometryStream : GeometryStream, IOpenGLResource
    {
        ...
        /// <summary>
        /// Gets the OpenGL vertex format that corresponds to the specified Sedulous vertex format.
        /// </summary>
        ...
        /// <summary>
        /// Gets the name of the shader attribute which corresponds to the specified Sedulous vertex usage.
        /// </summary>
        ...
        // The names of vertex attributes which correspond to Sedulous vertex usages.

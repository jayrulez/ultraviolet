...
{
    /// <summary>
    /// Represents the OpenGL implementation of the Sedulous Graphics subsystem.
    /// </summary>
    public sealed class OpenGLSedulousGraphics : SedulousResource, ISedulousGraphics
    {
        /// <summary>
        ...
        public unsafe OpenGLSedulousGraphics(SedulousContext uv, SedulousConfiguration configuration) : base(uv)
        {
            ...
            if (!OpenGLEnvironment.SetSwapInterval(1) && uv.Platform != SedulousPlatform.iOS)
        ...
        public void UpdateFrameRate(SedulousTime time)
        {
        ...
        /// </summary>
        private static IntPtr? TryCreateOpenGLContext(SedulousContext uv, OpenGLEnvironment environment,
            Version versionRequested, Version versionRequired, Boolean debug, Boolean throwOnFailure)
        {
            ...
            var gles = (uv.Platform == SedulousPlatform.Android || uv.Platform == SedulousPlatform.iOS);
        ...
        /// <summary>
        /// Verifies that the graphics device supports all of the functionality required by Sedulous.
        /// </summary>
        ...
        /// <summary>
        /// Gets the OpenGL index element format that corresponds to the specified Sedulous index element type.
        /// </summary>
        ...
        /// <summary>
        /// Gets the OpenGL primitive type that corresponds to the specified Sedulous primitive type.
        /// </summary>
        ...
        private static void DebugCallbackThunk(UInt32 source, UInt32 type, UInt32 id, UInt32 severity, Int32 length, IntPtr message, IntPtr userParam)
        {
            ...
            var gfx = uv.GetGraphics() as OpenGLSedulousGraphics;
            if (gfx == null)
                return;
        ...
        {
            isGLES = (Sedulous.Platform == SedulousPlatform.Android || Sedulous.Platform == SedulousPlatform.iOS);
        ...
        /// </summary>
        /// <param name="configuration">The Sedulous Framework configuration settings for the current context.</param>
        private void InitializeDebugOutput(SedulousConfiguration configuration)
        {
        ...
        /// <summary>
        /// Converts an Sedulous screen region to OpenGL coordinates.
        /// </summary>

...
namespace Sedulous.OpenGL
{
    ...
    /// </summary>
    public sealed class OpenGLGraphicsSubsystem : FrameworkResource, IGraphicsSubsystem
    {
        /// <summary>
        ...
        public void UpdateFrameRate(FrameworkTime time)
        {
        ...
        private static void DebugCallbackThunk(UInt32 source, UInt32 type, UInt32 id, UInt32 severity, Int32 length, IntPtr message, IntPtr userParam)
        {
            ...
            var gfx = uv.GetGraphics() as OpenGLGraphicsSubsystem;
            if (gfx == null)
                return;
        ...
        /// </summary>
        /// <param name="configuration">The Sedulous Framework configuration settings for the current context.</param>
        private void InitializeDebugOutput(FrameworkConfiguration configuration)
        {
